...
class UT_TextEdit_Zone(Zone):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.zone1 = Zone(self, pos=(10, 10), size=(self.rect.w / 2 - 15, self.rect.h - 20),
                          background_color=(100, 100, 100, 50))
        self.zone2 = Zone(self, pos=(self.zone1.rect.right + 10, 10), size=(self.rect.w / 2 - 15, self.rect.h - 20),
                          background_color=(100, 100, 100, 50))
